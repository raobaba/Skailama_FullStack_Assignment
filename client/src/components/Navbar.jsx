    ...
    <div className="MainNavbar bg-gradient-to-r from-purple-200 via-yellow-100 to-indigo-300 md:w-full lg:w-full w-full justify-between h-16 mx-auto top-0 shadow-md flex font-sans rounded-bl-5 rounded-br-5 backdrop-blur z-10 m-auto sticky">
      ...
      <div className="desk-navbar lg:w-70 w-3/5 justify-between flex">
        <div className="Navbar-links w-2/5 flex items-center justify-between font-semibold text-rgb-70-79-94">
          <Link className="no-underline font-plusjakartasans text-gray-700 text-base" to="/">
            Home
          </Link>
          <Link className="no-underline font-plusjakartasans text-gray-700 text-base" to="/team">
            Apps
          </Link>
          <Link className="no-underline font-plusjakartasans text-gray-700 text-base" to="/contact">
            Services
          </Link>
          <Link className="no-underline font-plusjakartasans text-gray-700 text-base" to="/careers">
            Blog
          </Link>
          <Link className="no-underline font-plusjakartasans text-gray-700 text-base" to="/careers">
            Partners
      ...
      >
        <div className="drawered xs:grid xs:ml-44 sm:grid sm:ml-44">
          ...
          <Link className="sm:text-20 sm:font-semibold sm:ml-[-6px]" to="/team">
            Team
          </Link>
          <Link className="sm:text-20 sm:font-semibold sm:ml-[-14px]" to="/contact">
            Contact
          </Link>
          <Link className="sm:text-20 sm:font-semibold sm:ml-[-14px]" to="/careers">
            Careers
          </Link>
