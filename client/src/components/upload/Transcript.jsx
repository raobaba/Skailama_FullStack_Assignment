    ...
    <div className="ml-16 mt-4">
      <div className="w-10/12 h-12 flex justify-between rounded-lg bg-purple-700">
        <div className="flex justify-center items-center ml-5">
          <p className="text-stone-100 font-semibold text-sm">All files are processed! Your winget is ready to go!</p>
        </div>
        <div className="flex justify-center items-center mr-5">
          <button className="w-20 h-8 bg-stone-100 rounded-md font-semibold text-xs">Try it out!</button>
        </div>
      </div>
      <div>
        <table className="border-collapse w-10/12 mt-4 shadow-md rounded-lg overflow-hidden">
          <thead>
            <tr className="font-medium">
              ...
              <th className="border-b border-t pr-10">
                Upload Date & Time
              </th>
