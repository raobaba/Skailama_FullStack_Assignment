  ...
  return (
    <div className="flex flex-col h-screen justify-between">
      <div>
        ...
        <div>
          <Link className="flex mt-2 items-center w-11/12 py-3 px-5 mx-2 rounded-3xl hover:bg-gray-200" activeClassName="bg-purple-200" to="/projects">
            <PiNumberCircleOneFill size={20} className=" bg-slate-100 text-slate-700 rounded-full "/>
            <p className="ml-2">Projects</p>
          </Link>
          <Link className="flex items-center w-11/12 py-3 px-5 mx-2 rounded-3xl hover:bg-gray-200" activeClassName="bg-purple-200" to="/winget-configurations">
            <PiNumberCircleTwoFill size={20} className=" bg-slate-100 text-slate-700 rounded-full "/>
            <p className="ml-2">Winget Configurations</p>
          </Link>
          <Link className="flex items-center w-11/12 py-3 px-5 mx-2 rounded-3xl hover:bg-gray-200" activeClassName="bg-purple-200" to="/deployment">
            <PiNumberCircleThreeFill size={20} className=" bg-slate-100 text-slate-700 rounded-full "/>
            <p className="ml-2">Deployment</p>
          </Link>
          <Link className="flex items-center w-11/12 py-3 px-5 mx-2 rounded-3xl hover:bg-gray-200" activeClassName="bg-purple-200" to="/pricing">
      ...
      <div>
        <Link className="flex items-center w-11/12 py-3 px-5 mx-2 rounded-3xl border-slate-500 hover:bg-gray-200" activeClassName="bg-purple-200" to="/settings">
