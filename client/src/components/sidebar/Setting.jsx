...
function Setting() {
  return (
    <div>
      ...
      <div>
        <h1  className='text-3xl font-bold text-purple-700 mt-8 ml-14'>Subscriptions</h1>
        <div className="w-10/12 h-12 mt-8 ml-14 flex justify-between rounded-lg bg-gradient-to-r from-purple-600 to-purple-900">
          <div className="flex justify-center items-center ml-5">
            <p className="text-stone-100 ">
              You are currently on the <span className="font-semibold text-xl underline cursor-pointer">Ques AI Basic Plan</span>
            </p>
          </div>
        ...
        <p className="font-bold text-red-700 ml-14 mt-8 underline cursor-pointer">Cencel Subscription</p>
      </div>
    </div>
  );
}
